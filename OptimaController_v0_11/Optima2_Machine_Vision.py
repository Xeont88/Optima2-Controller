...
class Optima2Controller(QMainWindow, design_v0_12.Ui_MainWindow, Gamepad, CD):
    '''
    ...
    def setup_connections(self):
        ...
        # self.checkBox_vacuum_pump.clicked.connect(self.servo_set_func)
        self.checkBox_vacuum_pump.clicked.connect(self.servo_control)
    ...
    def go_home(self):
        ...
        self.move_in_point(['0', '0', '0', '0', '0', '0', '0', '0', '9'])
    ...
    def add_point_in_scenario(self):
        ...
        # TODO: тправляется false/true вместе 0/1
        vacuum_grip = str(int(self.checkBox_vacuum_pump.isChecked()))

        text = ax1 + DELIMIT + ax2 + DELIMIT + ax3 + DELIMIT + ax4 + DELIMIT + ax5 + DELIMIT \
               + ax6 + DELIMIT + gripper + DELIMIT + carousel + DELIMIT + vacuum_grip + '\n'
    ...
    def servo_control(self):
        ...
        self.serial_send([1, self.servoSlider1.value(),
                          ...
                          int(self.checkBox_vacuum_pump.isChecked()),
                          0])
    ...
    def set_axis_list_to(self):
        ...
        self.axis_list[8] = int(self.checkBox_vacuum_pump.isChecked())
        print('vacuum', self.axis_list[8])
    ...
    def binding_sticks(self, x, y, z, table, axis_6, pump_btns=[0, 0]):
        ...
        if pump_btns[0] and not pump_btns[1]:
            self.axis_list[8] = 1
        if pump_btns[1] and not pump_btns[0]:
            self.axis_list[8] = 0
        # print(axis_list)
        self.axis_set_func()
