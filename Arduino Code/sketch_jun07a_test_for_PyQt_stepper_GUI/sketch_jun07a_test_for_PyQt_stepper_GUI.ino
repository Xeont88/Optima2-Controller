...
void setup() {
  ...
  stepper1.setCurrentPosition(90*88);
  stepper2.setCurrentPosition(60*45);
  stepper3.setCurrentPosition(60*98);
  stepper4.setCurrentPosition(90*46);
  stepper5.setCurrentPosition(90*20);
  stepper7.setCurrentPosition(360*8.9);
